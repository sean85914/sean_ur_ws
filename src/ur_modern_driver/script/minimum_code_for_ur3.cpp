...
#include <ur_kin/ur3_kin.h>

const double joint_standby[6] = {.500147819519043, -1.7680037657367151, -0.6063459555255335, -1.5455806891070765, -1.5018518606769007, 0.7908712029457092};
const double joint_home[6] = {0, -1.570724, 0, -1.570724, 0, 0};
const double tcp_length = 0.0; // No gripper
